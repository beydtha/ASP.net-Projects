...
namespace BiddaNiketon.Controllers
{
    public class InstructorController : Controller
    {
        ...
        private void PopulateAssignedCourseData(Instructor instructor)
        {
            ...
            var instructorAllCourses = new HashSet<int>(instructor.Courses.Select(c => c.CourseID));
            ...
            foreach(var course in allCourses)
            {
                ...
                Title = course.Title,
                Assigned = instructorAllCourses.Contains(course.CourseID)
        ...
        public ActionResult EditPost(int? id, string[] selectedCourses)
        {
            ...
            if (TryUpdateModel(instructorToUpdate, new string[] { "LastName", "FirstMidName", "HireDate", "OfficeAssignment" }))
            {
                try
                {
                    ...
                    updateAssignCourseData(selectedCourses, instructorToUpdate); 
                    db.SaveChanges(); 
                    return RedirectToAction("Index");
                }
        ...
        private void updateAssignCourseData(string [] selectedCourses, Instructor instructorToUpdate )
        {
            if(selectedCourses == null)
            {
